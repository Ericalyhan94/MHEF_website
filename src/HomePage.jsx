...
import company8 from './assets/company_8.png';
  ...
  return (
    <div className="">
      ...
      <div className="bg-red-50 py-10">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-[repeat(auto-fit,minmax(120px,1fr))] gap-4 px-4">
          {companyLogos.map((logo, index) => (
            <div
              key={index}
              className="flex items-center justify-center p-2 bg-white rounded-lg shadow hover:scale-105 transition-transform duration-300"
            >
